...
const FeatureSection = ({ title, description, imageSrc, features }) => (
  <div className="flex flex-col items-center mt-32">
    <h2 className="text-4xl text-center">{title}</h2>
    <p className="text-lg text-center mt-2">{description}</p>
    <img src={imageSrc} alt={title} className="w-3/4 mt-8" />
...
const FeaturesData = () => {
  const featureSections = [
    {
      ...
      imageSrc: "https://clockify.me/assets/images/features/features-tracker-screenshot.svg",
      features: [
        { title: "Timer", description: "Track time using a stopwatch." },
        { title: "Add Time", description: "Enter and edit hours manually." },
        { title: "Continue", description: "Continue tracking with one click." },
        { title: "Billable", description: "Mark hours as billable." },
      ]
    },
    {
      title: "Time Sheet",
      description: "Log your weekly activities in less than a minute.",
      imageSrc: "https://clockify.me/assets/images/features/features-timesheet-screenshot.svg",
      features: [
        { title: "Activities", description: "Select activity and enter time." },
        { title: "Templates", description: "Select activity and enter time." },
        { title: "Approval", description: "Submit and approve timesheets" },
        { title: "Reminders", description: "Reminder for due timesheets." },
      ]
    },
  ...
  return (
    <>
      <div className="flex flex-col items-center w-[97vw] mx-auto">
