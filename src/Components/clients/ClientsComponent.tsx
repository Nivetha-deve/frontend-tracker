...
export const ClientsComponent = () => {
  ...
  return (
    <div className="bg-[#f2f6f8] p-11 sm:p-3">
      <h1 className="mb-10 text-2xl text-[#666666] font-normal">Clients</h1>
      
      <div className="flex flex-col lg:flex-row mb-5 space-y-4 lg:space-y-0 lg:space-x-4">
        <select className="bg-white border border-gray-300 p-2">
          <option value="show all">Show active</option>
          <option value="show active">Show archived</option>
          <option value="show inactive">Show all</option>
        </select>
        ...
        <button
          onClick={onClick}
          className="bg-[#038fce] text-white p-2 hover:bg-[#026d9e]"
        >
          ADD
        </button>
      </div>
      ...
      <div className="border border-gray-300">
        <div className="bg-[#e4eaee] flex p-2">
          <div className="w-1/3 pl-5">NAME</div>
          <div>ADDRESS</div>
        </div>
        {clients.clients.map((client) => (
          <div key={client.name} className="bg-white flex border-b border-gray-300">
            <div className="w-1/3 p-2 pl-5">{client.name}</div>
            <div className="w-2/3 p-2 border-l border-dashed">{client.address}</div>
            <div className="w-16 p-2 border-l border-dashed">
              <EditClientModal />
            </div>
            <div className="w-16 p-2 border-l border-dashed">
              <DeleteClientModal
